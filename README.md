...
# pre requisite's
- make sure the minecraft and factorio server are located at C:\factorio and C:\minecraft
- install autohotkey v1. You can just google it.
- Make sure the bat files to start the servers look like the example files included.
