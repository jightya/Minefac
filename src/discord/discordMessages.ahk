setDiscordMessages() {
    ...
    global DiscordMsgStartupMinecraftModdedServer           := " " discordMsgTime  " ** "  "Continuing to start modded minecraft server." " "
    ...
    global DiscordMsgShutdownMinecraftModdedServer          := " " discordMsgTime  " ** "  "Shutting down modded minecraft server." " "
    ...
    global DiscordMsgBackupModdedMinecraftServer            := " " discordMsgTime  " ** "  "Backupping modded minecraft server." " "
    ...
    global DiscordMsgModdedMinecraftCrashed                 := " " discordMsgTime  " ** "  "It looks like the modded minecraft server crashed. Attempting to restart it. " "Crash counter: " moddedMinecraftCrashes " "
